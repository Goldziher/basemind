...
impl LazyValue {
    ...
    pub(super) fn evaluate_as_graph_node(&self, exec: &mut EvaluationContext) -> Result<GraphNodeRef, ExecutionError> {
...
impl LazyScopedVariable {
    ...
    fn resolve(&self, exec: &mut EvaluationContext) -> Result<LazyValue, ExecutionError> {
        let scope = self
            .scope
            .as_ref()
