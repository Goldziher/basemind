...
//! Maintained fork of `tree-sitter-graph` (origin repo <https://github.com/Goldziher/basemind>),
//! originally derived from tree-sitter/tree-sitter-graph v0.12.0 and modernized (tree-sitter 0.26,
//! edition 2024). See `ATTRIBUTIONS.md` for provenance.
//!
