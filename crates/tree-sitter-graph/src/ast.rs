...
impl std::fmt::Display for Assign {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "set {} = {} at {}", self.variable, self.value, self.location,)
    }
}
...
impl std::fmt::Display for CreateEdge {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "edge {} -> {} at {}", self.source, self.sink, self.location,)
    }
}
...
impl std::fmt::Display for DeclareImmutable {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "let {} = {} at {}", self.variable, self.value, self.location,)
    }
}
...
impl std::fmt::Display for DeclareMutable {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "var {} = {} at {}", self.variable, self.value, self.location,)
    }
}
...
#[derive(Debug, PartialEq, Eq)]
pub enum Condition {
    Some { value: Expression, location: Location },
    None { value: Expression, location: Location },
    Bool { value: Expression, location: Location },
}
...
impl std::fmt::Display for ListComprehension {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "[ {} for {} in {} ]", self.element, self.variable, self.value)
    }
}
